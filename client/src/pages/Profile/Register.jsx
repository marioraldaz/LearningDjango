    ...
    <div className="flex items-center justify-center mt-[40px]">
       <form onSubmit={handleSubmit} className="w-[500px] bg-neutral-800 p-[50px] h-full rounded-2xl text-black" >
        ...
        {error && <h1 className="text-red-600 mt-8">{error}</h1>}
          ...
          <div className="mt-10 flex justify-center items-center flex-col">
            <label htmlFor="repeatPassword" className="block text-green-600 font-semibold">Repeat Password:</label>
            <input
              type="password"
              id="repeatPassword"
              name="repeatPassword"
          ...
          <div className="mt-10 flex justify-center items-center flex-col">
          <label htmlFor="gender" className="block text-green-600 font-semibold mb-2">Gender:</label>
          ...
          <label htmlFor="email" className="block text-green-600 font-semibold mb-2">Email:</label>
             <input type="email" id="email" name="email" placeholder="Enter your email" required/>
          </div>
          <div className="m-10 flex justify-center items-center flex-col">
            <label htmlFor="date_of_birth" className="block text-green-600 font-semibold mb-2">Birthdate:</label>
