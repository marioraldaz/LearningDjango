...
export function FoodIntake() {
  ...
  return (
    <section className="p-4 grid 2xl:grid-cols-3 xl:grid-cols-2 bg-black grid-cols-1 mt-[50px] justify-center items-center">
      ...
      <div className="order-3 2xl:order-3 h-[700px] w-[430px] flex flex-col overflow-y-auto items-center bg-neutral-700 p-4 rounded-lg ml-auto mr-auto mt-4">
