export const filters = [
  ...
  },
  {
    ...
    label: "Maximum Protein Percentage",
    type: "number",
  },
  { name: "minFatPercent", label: "Minimum Fat Percentage", type: "number" },
  { name: "maxFatPercent", label: "Maximum Fat Percentage", type: "number" },
  {
    name: "minCarbsPercent",
    label: "Minimum Carbs Percentage",
    type: "number",
  },
  {
