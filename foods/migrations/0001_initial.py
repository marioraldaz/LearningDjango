# Generated by Django 5.0.2 on 2024-04-09 17:49
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('nutrition', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='recipe_ingredient', to='foods.nutrition')),
            ],
        ),
        migrations.CreateModel(
            name='Recipe',
            fields=[
                ...
                ('readyInMinutes', models.IntegerField(blank=True, null=True, validators=[django.core.validators.MinValueValidator(0)])),
                ('spoonacular_id', models.IntegerField(unique=True)),
                ('sourceName', models.CharField(max_length=100)),
                ('sourceUrl', models.URLField(max_length=600)),
                ('healthScore', models.FloatField(null=True, validators=[utils.validators.validate_positive_float])),
                ('spoonacularScore', models.FloatField(null=True, validators=[utils.validators.validate_positive_float])),
                ('pricePerServing', models.FloatField(null=True, validators=[utils.validators.validate_positive_float])),
                ...
                ('ingredients', models.ManyToManyField(related_name='recipes', to='foods.ingredient')),
                ('nutrition', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='recipe_nutrition', to='foods.nutrition')),
            ],
        ),
    ]
