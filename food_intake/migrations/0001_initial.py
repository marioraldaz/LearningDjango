# Generated by Django 5.0.2 on 2024-04-09 18:01
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_daily', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='food_intake.userdaily')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('food_intake', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='details', to='food_intake.foodintake')),
            ],
        ),
        migrations.CreateModel(
            name='NutritionStats',
            fields=[
                ...
                ('last_30_days_saturated_fat', models.FloatField(blank=True, null=True)),
                ('last_30_days_carbohydrates', models.FloatField(blank=True, null=True)),
